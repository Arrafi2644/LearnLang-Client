            ...
            >
                <SwiperSlide className='bg-slide1-bg w-full bg-center bg-cover bg-no-repeat'>
                    <div className='text-center h-[500px] flex items-center justify-center flex-col'>
                        ...
                        <p className='text-text-light text-center w-full md:w-4/5 lg:w-3/5 mx-auto font-medium bg-[#ffffff4f] my-2'>Explore personalized learning sessions to achieve your language goals with ease and confidence</p>
                ...
                <SwiperSlide className='bg-slide2-bg w-full bg-center bg-cover bg-no-repeat min-h-[500px]'>
                    <div className='text-center  h-[500px] flex items-center justify-center flex-col'>
                        ...
                        <p className='text-text-light text-center w-full md:w-4/5 lg:w-3/5 mx-auto font-medium bg-[#ffffff4f] my-2'>Explore personalized learning sessions to achieve your language goals with ease and confidence</p>
                        <button className='btn bg-accent-light'>Find Your Tutor</button>
                    </div>
                </SwiperSlide>
