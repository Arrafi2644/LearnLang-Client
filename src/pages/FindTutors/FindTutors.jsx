...
const FindTutors = () => {
    ...
    return (
        <div className='my-10 md:my-14 px-4 container mx-auto min-h-screen'>
         {
            isLoading?
            <span className="loading loading-ring loading-lg text-primary-light  absolute left-1/2 -translate-x-1/2 top-24"></span>
            :
   <div>
            ...
            <div className='flex items-center gap-4'>
                ...
                <fieldset className="fieldset min-h-0 h-auto border border-gray-400 rounded-md">
                    <select defaultValue="Pick a browser" className="select text-sm min-h-0 h-auto py-2 px-4 min-w-40 bg-white">
